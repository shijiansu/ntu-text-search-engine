...
<body>
	<h3>CI6226: Information Retrieval and Analysis (Test Data2)</h3>
	<form action="${pageContext.request.contextPath}/search" target="_blank" method="post">
		<input type="hidden" name="case" value="false">
		<input type="hidden" name="stop" value="false">
		<input type="hidden" name="stem" value="false">
		...
		<table class="tg">
			<tr>
				<td>Is Case Sensitive: false, Is Excluded Stop Words: false, Is Performing Stem: false, TopN: 10, Key Word: definitely, latitude: 35, latitude range: 0, longitude: -81, longitude range: 0</td>
				<td> 
